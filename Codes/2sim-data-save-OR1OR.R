...
# Use pblapply to run the simulations in parallel with progress bar
results <- tryCatch({
  pblapply(1:nSim, function(i) simulate(i, simdata, rhc_prep3, x.var, exposure, nSim, intermediate_dir), cl = cl)
}, error = function(e) {
